package fyt.business.core.netty.handler;

import fyt.business.core.serializable.kryo.KryoUtil;
...
public class HttpHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        System.out.println("server 收到消息！:"+ KryoUtil.unSerializable((byte[])msg));
        ctx.channel().writeAndFlush("你好客户端 这是服务端发送的消息："+KryoUtil.serializable(LocalDateTime.now()));
